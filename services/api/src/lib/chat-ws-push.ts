...
// and will include both secrets after the chat-ws stack is first deployed.
// Declared here so typecheck passes ahead of the first SST run. Mirrors the
// shape declared in chat-internal.ts; interface-merging keeps them in sync.
declare module "sst" {
  interface Resource {
    ChatWsHmacSecret: {
      type: "sst.sst.Secret";
